...
def create_analysis_results(df):
    total_jobs = len(df)
    avg_salary = df["salary"].mean()
    python_jobs = df[df["skills"].str.contains("Python", na=False)]
    data_analysis_jobs = df[df["title"].str.contains("数据分析", na=False)]
    ...
    results = {
        ...
        "data_analysis_job_count": len(data_analysis_jobs),
        "city_counts": city_counts,
        "skill_counts": skill_counts,
        "city_salary": city_salary,
        "city_salary_sorted": city_salary_sorted,
